    ...
    return (
        <div className={'AllComponentAutorizaite'}>
            <div className={'AllContentBoxAutorizait '}>
                <h2>Пожалуйста зарегестрируйтесь или войдите </h2>
                {(NikD && NikEror) && <div style={{color: "red"}}>{NikEror}</div>}
                <input className={"AuthInput"}  onChange={e => NikHandline(e)} value={Nik} onBlur={e => blurHandler(e)} name={'Nik'}
                       type="text" placeholder={'Введите ник'}/>
                ...
                <div className={'ButtonBox'}>
                    ...
                    <NavLink to={'/main/Home'}>
                        <button className={"AuthButton"} disabled={!formValid}>Зарегестрироваться</button>
                    </NavLink>
                </div>
            </div>
        </div>
